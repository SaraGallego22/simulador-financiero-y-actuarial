...
`solRk` generaliza esa misma fórmula a los cuatro módulos (`R = [rSusc, rFin, rOp, rConc]`) vía la matriz `CORR_MOD_CONCENTRACION` (`src/domain/finance/constants.ts`):

| ρ | rSusc | rFin | rOp | rConc |
|---|---|---|---|---|
| **rSusc** | 1 | 0.75 | 1 | 0.75 |
| **rFin** | 0.75 | 1 | 1 | 0.5 |
| **rOp** | 1 | 1 | 1 | 1 |
