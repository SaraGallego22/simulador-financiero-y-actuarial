...
/** Greedy word-wrap so competency labels (up to "Tolerancia a la frustración") fit around the chart without overlapping. */
 ...
 */
export function SoftSkillsRadarChart({ scores, size = 260 }: { scores: Partial<Record<SoftSkillCompetency, number>>; size?: number }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <svg viewBox={`0 0 ${size} ${size}`} width={size} height={size} role="img" aria-label="Radar de habilidades blandas">
