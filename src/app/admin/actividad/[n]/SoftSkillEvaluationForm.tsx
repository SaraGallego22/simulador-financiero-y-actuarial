...
export function SoftSkillEvaluationForm({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="col-span-full mt-1 w-fit rounded bg-[var(--color-brand-blue)] px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-[var(--color-brand-blue-dark)]"
      >
        Guardar
      </button>
    </form>
